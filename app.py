...
body {
    background: linear-gradient(120deg, #87CEEB, #e6f2ff);
}
...
.hero {
    background: linear-gradient(90deg, #0f4c81, #1f6fe5);
    padding: 50px;
    border-radius: 22px;
    color: white;
    text-align: center;
...
.stButton button {
    background: linear-gradient(90deg, #1f6fe5, #0f4c81);
    color: white;
    font-size: 16px;
    font-weight: 600;
    border-radius: 10px;
